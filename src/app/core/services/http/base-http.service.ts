...
export abstract class BaseHttpService {
  ...
  /**
   * PATCH request with merge-patch+json content type (required by API Platform for PATCH)
   */
  protected patchWithMergePatch<T>(url: string, body: unknown): Observable<T> {
